...
public class TelaFuncionario extends javax.swing.JFrame {
    ...
    private final TelaCadastroCliente telaCadastrarCliente;
    private final TelaVerificarEstoque telaVerificarEstoque;
    private final TelaCadastroProduto telaCadastrarProduto;
    ...
    public TelaFuncionario() {
        ...
        telaCadastrarCliente = new TelaCadastroCliente();
        telaVerificarEstoque = new TelaVerificarEstoque();
        telaCadastrarProduto = new TelaCadastroProduto();
        telaLogin = new TelaLogin();
        
        produtoTB = new ProdutoTableModel();
        
        jTProdutos.setModel(produtoTB);
        jTProdutos.getColumnModel().getColumn(0).setPreferredWidth(125);
        jTProdutos.getColumnModel().getColumn(1).setPreferredWidth(125);
        jTProdutos.getColumnModel().getColumn(2).setPreferredWidth(125);
        jTProdutos.getColumnModel().getColumn(3).setPreferredWidth(125);
    ...
    private void initComponents() {
        ...
        jBNovoCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/novoCliente.png"))); // NOI18N
        ...
        jBVerificarEstoque.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/VerEstoque.png"))); // NOI18N
        jBVerificarEstoque.setText("Verificar Estoque");
        jBVerificarEstoque.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBVerificarEstoqueActionPerformed(evt);
            }
        });

        jBCadastrarProduto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/add.png"))); // NOI18N
        ...
        jBOk.setBackground(new java.awt.Color(0, 102, 255));
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jTFCodigoBarras, javax.swing.GroupLayout.PREFERRED_SIZE, 490, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jBOk, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(147, 147, 147))))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTFCodigoBarras, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLPrecoTotal.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLPrecoTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
        ...
        jBConfirmar.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBConfirmar, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jBConfirmar, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jBOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBOkActionPerformed
        ...
        jLPrecoTotal.setText(String.valueOf(precoTotal));
        
    }//GEN-LAST:event_jBOkActionPerformed
     private Produto busca () {
        String codigo = jTFCodigoBarras.getText();
        Produto produto = fachada.findByCodigoBarras(Integer.parseInt(codigo));
        
        if(produto != null){
            for (int i = 0; i < produtoTB.getRowCount(); i++) {
                produtoTB.removeElement(i);
            }
            if (Long.toString(produto.getCodigoBarras()).equalsIgnoreCase(codigo)) {
                produtoTB.addElement(produto);
            }
            return produto;
        }
        else{
    ...
    private void jBConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBConfirmarActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(null, "Não foi implementado ainda!");
